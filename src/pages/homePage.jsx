                ...
                <div className = "container-fluid" style = {styleForContainer}>
                    ...
                    <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                        <div className="col-md-4 d-flex align-items-center">
                            ...
                            <a href = "https://www.linkedin.com/in/tw-uriah-chen/" target="_blank" rel="noreferrer" style={styleForLeetCodeIcon}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" fill="rgb(2, 149, 231)" className="bi bi-linkedin" viewBox="0 0 16 16">
